...
const Navbar = () => {
    ...
    const {setShowSearch , getCartCount} = useContext(AppContext);
  return (
    <div className='flex item-center justify-between py-5 font-medium'>
        ...
        <div className='flex item-center gap-6'>
            ...
            <p className='absolute right-[-5px] top-[15px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>
                {getCartCount()}
            </p>
            </Link>
